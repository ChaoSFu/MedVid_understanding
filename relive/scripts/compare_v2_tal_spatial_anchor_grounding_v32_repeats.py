...
from relive.v2.spatial_anchor_grounding_v32_repeat import compare,SpatialAnchorRepeatError
...
except SpatialAnchorRepeatError as e:print(f'ReliVE-v2 TAL spatial-anchor v3.2 repeat error: {e}');raise SystemExit(2)

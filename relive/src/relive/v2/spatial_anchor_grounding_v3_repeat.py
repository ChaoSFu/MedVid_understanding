"""Zero-model comparison of two independent Stage 3G-A v3 fresh runs."""
...
def compare(*,run_a:Path,run_b:Path,output_dir:Path)->dict[str,Any]:
 ...
 ma,mb=_obj(run_a/'run'/'v2_tal_stage3g_v3_manifest.json'),_obj(run_b/'run'/'v2_tal_stage3g_v3_manifest.json')
 a,b=_rows(run_a/'run'/'v2_tal_spatial_anchor_groundings_v3.jsonl'),_rows(run_b/'run'/'v2_tal_spatial_anchor_groundings_v3.jsonl')
